...
const SingleProject = ({ project }) => {
  return (
    <div className="flex justify-center flex-col items-center gap-10 min-h-fit ">
      ...
      <Link
        href="/main"
        className="button rounded-full border border-slate-600 max-w-[170px] px-8 transition-all duration-300 flex items-center justify-center overflow-hidden hover:border-primary group"
      >
        <span className="group-hover:-translate-y-[140%] group-hover:opacorty-0 transition-all duration-500">
          Go Back
        </span>
