        ...
        <div className="flex flex-col w-full max-2-[700px] ">
          ...
          >
            ...
            >
              ...
              <GoArrowRight className="-translate-y-[140%] opacity-0 group-hover:flex group-hover:-translate-y-0 group-hover:opacity-100 transition-all duration-300 absolute text-[22px]" />
            </button>
          </motion.form>
        </div>
      </div>
